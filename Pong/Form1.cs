...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        int ballx = Convert.ToInt32(Interaction.InputBox("Enter the ball's horizontal speed. This will make it more difficult the higher it is.", "Horizontal speed", "7", 434, 297));
        int bally = Convert.ToInt32(Interaction.InputBox("Preferably the same as the horizontal speed. Change it for a challenge!", "Vertical speed", "7", 434, 297));
        ...
        private void timerTick(object sender, EventArgs e)
        {
            ...
            {
                gameTimer.Stop();
                MessageBox.Show("You win this game! Your score is " + Convert.ToString(10-cpuPoint) + "!");
            }
